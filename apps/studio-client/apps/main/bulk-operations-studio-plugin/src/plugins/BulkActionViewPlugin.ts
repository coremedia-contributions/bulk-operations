              ...
              Config(SearchToolbar, {
                plugins: [
                  Config(RemoveItemsPlugin, {
                    items: [Config(Item, { itemId: "createImageGallery" }), Config(Item, { itemId: "createSpinner" })],
                  }),
                  Config(AddItemsPlugin, {
                    ...
                    after: [Config(Component, { itemId: "createImageMap" })],
                  }),
                ],
              }),
              ...
              Config(RepositoryToolbar, {
                plugins: [
                  ...
                  Config(AddItemsPlugin, {
                    ...
                    before: [Config(Component, { itemId: "createImageMap" })],
                  }),
                ],
              }),
            ],
