...
import OpenCreateImageGalleryWindowAction from "@coremedia/studio-client.main.bpbase-studio-components/pictures/gallery/OpenCreateImageGalleryWindowAction";
import OpenCreateSpinnerWindowAction from "@coremedia/studio-client.main.bpbase-studio-components/pictures/spinner/OpenCreateSpinnerWindowAction";
...
interface BulkOperationsMenuButtonConfig
  extends Config<IconButton>,
    Partial<Pick<BulkOperationsMenuButton, "contentValueExpression">> {}
...
class BulkOperationsMenuButton extends IconButton {
  ...
  constructor(config: Config<BulkOperationsMenuButton> = null) {
    super(
      ConfigUtils.apply(
        Config(BulkOperationsMenuButton, {
          itemId: "bulkActions",
          iconCls: SvgIconUtil.getIconStyleClassForSvgIcon(icon),
          tooltip: BulkOperations_properties.bulk_edit_menu_tooltip,
          ...
          menu: Config(Menu, {
            items: [
              ...
              Config(Item, {
                baseAction: new OpenCreateImageGalleryWindowAction({
                  contentValueExpression: config.contentValueExpression,
                }),
              }),
              Config(Item, {
                baseAction: new OpenCreateSpinnerWindowAction({
                  contentValueExpression: config.contentValueExpression,
                }),
              }),
            ],
